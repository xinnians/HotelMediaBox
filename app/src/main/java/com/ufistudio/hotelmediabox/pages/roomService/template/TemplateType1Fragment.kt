...
class TemplateType1Fragment : InteractionView<OnPageInteractionListener.Primary>(), OnFragmentKeyListener, ViewPager.OnPageChangeListener {

    private lateinit var mViewModel: TemplateType1ViewModel
    private lateinit var mData: RoomServiceCategories
    private var mAdapter: TemplateType1PagerAdapter? = null
    ...
    override fun onStart() {
        super.onStart()
        mAdapter = TemplateType1PagerAdapter(context!!, mData)
