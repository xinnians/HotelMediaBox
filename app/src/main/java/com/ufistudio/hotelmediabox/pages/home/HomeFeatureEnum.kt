...
enum class HomeFeatureEnum(tag: String, title: Int, page: Int, focusedIcon: Int, icon: Int) {
    ...
    VOD("vod_movies", R.string.home_icon_vod, -100, R.drawable.ic_vod_1, R.drawable.ic_vod),
    SMART_APP("smart_apps", R.string.home_icon_smart_app, -100, R.drawable.ic_smart_apps_1, R.drawable.ic_smart_apps),
    ...
    NEAR_BY("nearby_me", R.string.home_icon_near_by, Page.NEARBY_ME, R.drawable.ic_nearby_me_1, R.drawable.ic_nearby_me),
    TOURIST_INFO("tourist_info", R.string.home_icon_tourist, -100, R.drawable.ic_tourist_info_1, R.drawable.ic_tourist_info),
