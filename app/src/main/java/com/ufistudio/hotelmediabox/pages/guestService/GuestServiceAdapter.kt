...
import com.ufistudio.hotelmediabox.repository.data.GuestCatagories
import kotlinx.android.synthetic.main.item_nearby_me.view.*

class GuestServiceAdapter(private var mClickListener: OnItemClickListener, private var mFocusListener: OnItemFocusListener) : RecyclerView.Adapter<GuestServiceAdapter.ViewHolder>() {
    ...
    companion object {
        ...
        val TAG: String = GuestServiceAdapter::class.java.simpleName
    }
    ...
    fun setData(data: ArrayList<GuestCatagories>) {
        mData.addAll(data)
        notifyDataSetChanged()
    }
