...
class ShoppingFragment : InteractionView<OnPageInteractionListener.Primary>(), OnFragmentKeyListener, ViewPager.OnPageChangeListener {
    ...
    companion object {
        fun newInstance(): ShoppingFragment = ShoppingFragment()
        private val TAG = ShoppingFragment::class.simpleName
